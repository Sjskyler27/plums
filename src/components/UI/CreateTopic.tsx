    ...
    return (
        ...
        <DialogActions>
          <div className='w-full text-center'>
            <button type="button" onClick={toggleCreateDialog} className='bg-blue pr-4 pl-4 pt-1 pb-1 mr-1 rounded-md text-white hover:bg-darkBlue hover:text-skyMagenta'>
                <MdClose style={{fontSize: "32px"}}/>
            </button>
            <button type="button" onClick={createTopic} className='bg-byzantium pr-4 pl-4 pt-1 pb-1 ml-1 rounded-md text-white hover:bg-skyMagenta hover:text-palePurple'>
