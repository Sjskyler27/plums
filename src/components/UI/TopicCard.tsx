      ...
      <div className='p-4'>
        ...
        <DialogContent>
            ...
            <div className='text-center sm:text-left sm:flex sm:justify-between mb-2 mt-2 gap-3'>
              ...
              <input type="text" name='color' id='color' onChange={ev => {setEditColor(ev.target.value)}} defaultValue={editColor} className='rounded-md border-byzantium border-2 p-2 w-full sm:w-56 sm:max-w-[256px]'/>
            </div>
            <div className='text-center sm:text-left sm:flex sm:justify-between mb-2 mt-2 gap-3'>
              <label htmlFor="image" className='mt-auto mb-auto'>Image</label>
              <input type="text" name="image" id="image" onChange={ev => {setEditImg(ev.target.value)}} defaultValue={editImg} className='rounded-md border-byzantium border-2 p-2 w-full sm:w-56 sm:max-w-[256px]'/>
            </div>
        </DialogContent>
        <DialogActions>
          <div className='w-full text-center'>
            ...
            <button type="button" onClick={updateTopic} className='bg-byzantium pr-4 pl-4 pt-1 pb-1 ml-1 rounded-md text-white hover:bg-skyMagenta hover:text-palePurple'>
